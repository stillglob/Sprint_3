...
class TestSignIn:
    ...
    def test_sign_in_from_start_page(self, mail, password, driver):
        ...
        WebDriverWait(driver, 5).until(expected_conditions.visibility_of_element_located(
            (By.XPATH, '//section[2]/div/button')
        ))
        assert 'Оформить заказ' == driver.find_element(By.XPATH, '//section[2]/div/button').text
        driver.quit()

    def test_sign_in_from_personal_area(self, mail, password, driver):
        driver.get('https://stellarburgers.nomoreparties.site')
    ...
    def test_sign_in_from_registration_page(self, mail, password, driver):
    ...
    def test_sign_in_from_forgot_page(self, mail, password, driver):
